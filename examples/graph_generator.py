...
def generate_graph(tpe='SM', params= {}):
    ...
    if tpe == 'SM_small':
    ...
    elif tpe == 'line' or tpe == 'line_semi' or tpe == 'line_PRA' or  tpe == 'line_semi_phase' :
    ...
    elif tpe == 'uniform_delaunay_0' or tpe == 'uniform_delaunay_1' or tpe == 'uniform_delaunay_2':
        ...
        for i in range(params['n']):
            for j in range(params['n']):
                point_test = np.array([x[j]+np.random.normal(0,params['eps']),x[i]+np.random.normal(0,params['eps'])])
